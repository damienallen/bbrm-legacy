...
var restarea = 80; //1) width of the "neutral" area in the center of the gallery in px
...
function enlargeimage(path, optWidth, optHeight) {
  ...
  var winattributes =
    "width=" + actualWidth + ",height=" + actualHeight + ",resizable=yes";
...
function moveleft() {
  if (iedom && loadedyes) {
    ...
    if (parseInt(cross_scroll_0.style.left) < -actualwidth)
      cross_scroll_0.style.left =
        parseInt(cross_scroll_1.style.left) + actualwidth + "px";
    if (parseInt(cross_scroll_1.style.left) < -actualwidth)
      cross_scroll_1.style.left =
        parseInt(cross_scroll_0.style.left) + actualwidth + "px";
    cross_scroll_0.style.left =
      parseInt(cross_scroll_0.style.left) - scrollspeed + "px";
    cross_scroll_1.style.left =
      parseInt(cross_scroll_1.style.left) - scrollspeed + "px";
    //showhidediv("visible")
  }
...
function fillup() {
  if (iedom) {
    ...
    extra.innerHTML = document.all
      ? document.all["trueContainer"].innerHTML
    ...
    actualwidth = document.all
      ? cross_scroll_0.offsetWidth
      : document.getElementById("trueContainer").offsetWidth;
